...
public class GameScr
{
    ...
    private static void loadConfigFile() {
        ...
        if (configMap.containsKey("version-Data")) {
            ...
            GameScr.vData += Util.nextInt(1,10);
        }
        else {
            GameScr.vData = 1;
        }
        if (configMap.containsKey("version-Map")) {
            ...
            GameScr.vMap += Util.nextInt(1,10);
        }
        else {
            GameScr.vMap = 1;
        }
        ...
        if (configMap.containsKey("version-Item")) {
            ...
            GameScr.vItem += Util.nextInt(1,10);
        }
        else {
            GameScr.vItem = 1;
        }
    ...
    protected static void init() {
        loadConfigFile();
        try {
            MySQL.createConnection(0, GameScr.mysql_host, "nja_data", GameScr.mysql_user, GameScr.mysql_pass);
