...
//            msg.writer().writeShort((short) 833);
//            final byte[] num52 = new byte[] {2,6,1,1,1,6};
//            final short idicon = 6000;
//            for (int i = 0; i < 6; i++) {
//                msg.writer().writeByte(num52[i]);
//                if (i == 0) {
//                    msg.writer().writeShort(idicon);
//                    msg.writer().writeShort((short) (idicon + 1));
//                } else if (i == 1) {
//                    msg.writer().writeShort((short) (idicon + 2));
//                    msg.writer().writeShort((short) (idicon + 2));
//                    msg.writer().writeShort((short) (idicon + 3));
//                    msg.writer().writeShort((short) (idicon + 3));
//                    msg.writer().writeShort((short) (idicon + 4));
//                    msg.writer().writeShort((short) (idicon + 4));
//                } else if (i == 2) {
//                    msg.writer().writeShort((short) (idicon + 5));
//                }
//                else if (i == 3) {
//                    msg.writer().writeShort((short) (idicon + 6));
//                }
//                else if (i == 4) {
//                    msg.writer().writeShort((short) (idicon + 7));
//                }
//                else {
//                    msg.writer().writeShort(idicon);
//                    msg.writer().writeShort(idicon);
...
//    }
    ...
    public static void onVithuInfo(Char _char, int charID) {
        Message msg = null;
        try {
            msg = new Message(117);
            msg.writer().writeByte(-1);
            msg.writer().writeByte(0);
            msg.writer().writeInt(charID);
            for (byte i = 0; i < _char.arrItemViThu.length; ++i) {
                final Item item = _char.arrItemViThu[i];
                if (item != null) {
                    msg.writer().writeShort(_char.arrItemViThu.length);
                    msg.writer().writeByte(item.upgrade);
                    msg.writer().writeLong(item.expires);
                    msg.writer().writeByte(item.sys);
                    msg.writer().writeByte(item.options.size());
    ...
    public static void onChangeVithu(Char _char, Mob mob) {
        Message msg = null;
        try {
            msg = new Message(117);
            msg.writer().writeByte(-1);
            ...
            msg.writer().writeInt(_char.charID);
            if (mob != null) {
                msg.writer().writeShort(_char.arrItemViThu[4].itemId);
                msg.writer().writeByte(Mob.arrMobTemplate[mob.templateId].isBoss ? 1 : 0);
                _char.user.session.sendMessage(msg);
            } else {
                msg.writer().writeShort(0);
